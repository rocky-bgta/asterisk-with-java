...
public class RTPCaptureSaveAudio {
    public static void main(String[] args) {
        ...
        //AudioFormat audioFormat = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, 8000, 16, 2, 2, 8000, false);
    ...
    private static class MyPacketHandler implements JPacketHandler<StringBuilder> {
        ...
        private void saveAsWav(byte[] audioData) {
            // Specify the file path as "C:\\"
            String filePath = "C:\\Audio\\";
            ...
            try {
                ...
                File wavFile = new File(filePath + "captured_audio.wav");
